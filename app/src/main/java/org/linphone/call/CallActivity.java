...
public class CallActivity extends LinphoneGenericActivity
    ...
    private RelativeLayout mButtons,
            ...
            mActiveCallHeader,
            mConferenceHeader;
    private LinearLayout mCallsList, mCallPausedByRemote, mConferenceList, menu;
    ...
    private TextView mContactName, mMissedMessages, hide;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout layout = findViewById(R.id.topLayout1);
        ...
        if (getScreenHeight() >= 800) {
            relativeParams.setMargins(
                    0, 0, 0, getPixelValue(this, getResources().getDimension(R.dimen._18sdp)));
        } else {
            relativeParams.setMargins(
                    0, 0, 0, getPixelValue(this, getResources().getDimension(R.dimen._13sdp)));
        }
