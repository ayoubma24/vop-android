...
public abstract class MainActivity extends LinphoneGenericActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigation.performHapticFeedback(
                HapticFeedbackConstants.VIRTUAL_KEY,
                HapticFeedbackConstants
                        .FLAG_IGNORE_GLOBAL_SETTING // Ignore device's setting. Otherwise, you can
                // use FLAG_IGNORE_VIEW_SETTING to ignore view's
                // setting.
                );
                ...
                new BottomNavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        ...
                        if (itemId == R.id.action_settings) {
                            ...
                            return true;
                        } else if (itemId == R.id.action_recents) {
                            Intent intent1 = new Intent(MainActivity.this, HistoryActivity.class);
                            addFlagsToIntent(intent1);
                            startActivity(intent1);

                            return true;
                        } else if (itemId == R.id.action_chat) {
                            Intent intent2 = new Intent(MainActivity.this, ChatActivity.class);
                            addFlagsToIntent(intent2);
                            startActivity(intent2);

                            return true;
                        } else if (itemId == R.id.action_keypad) {
                            Intent intent3 = new Intent(MainActivity.this, DialerActivity.class);
                            addFlagsToIntent(intent3);
                            startActivity(intent3);
                            return true;
                        } else if (itemId == R.id.action_voicemail) {
                            LinphoneManager.getCallManager().newOutgoingCall("*97", "*97");
                            // goBackToCall();
                            return true;
                        }
                        return true;
        ...
        // mSideMenuFragment.setMenuVisibility(false);
    ...
    protected void onDestroy() {
        ...
        if (LinphoneService.isReady()) LinphoneService.instance().stopSelf();
