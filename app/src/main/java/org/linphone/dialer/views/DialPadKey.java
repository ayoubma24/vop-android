...
public class DialPadKey extends LinearLayout {
    ...
    public DialPadKey(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a =
                context.getTheme()
                        .obtainStyledAttributes(attrs, R.styleable.DialPadKey, 0, defStyleAttr);
        ...
        try {
            ...
            mEqualSpacing =
                    a.getBoolean(R.styleable.DialPadKey_equalSpacing, DEFAULT_EQUAL_SPACING);
        } finally {
            a.recycle();
        }
        inflate(getContext(), R.layout.dialpad_key, this);
        ((Digit) findViewById(R.id.dialpad_key_number)).setText(numberText);
