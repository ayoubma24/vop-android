...
import static org.linphone.utils.LinphoneUtils.getPixelValue;
import static org.linphone.utils.LinphoneUtils.getScreenHeight;
...
public class DialerActivity extends MainActivity implements AddressText.AddressChangedListener {
    ...
    private void initUI(View view) {
        ...
        numpadLayout = view.findViewById(R.id.numpad_layout);
        ...
        // Toast.makeText(this, "Screen height: " + getScreenHeight(), Toast.LENGTH_LONG).show();

        if (getScreenHeight() >= 800) {
            int left = getPixelValue(this, getResources().getDimension(R.dimen._8sdp));
            int top = getPixelValue(this, getResources().getDimension(R.dimen._40sdp));
            int right = getPixelValue(this, getResources().getDimension(R.dimen._8sdp));
            int bottom = getPixelValue(this, getResources().getDimension(R.dimen._7sdp));

            layoutParams.setMargins(left, top, right, bottom);
            numpadLayout.setLayoutParams(layoutParams);
        } else if (getScreenHeight() >= 750) {
            int left = getPixelValue(this, getResources().getDimension(R.dimen._8sdp));
            int top = getPixelValue(this, getResources().getDimension(R.dimen._20sdp));
            int right = getPixelValue(this, getResources().getDimension(R.dimen._8sdp));
            int bottom = getPixelValue(this, getResources().getDimension(R.dimen._7sdp));
            layoutParams.setMargins(left, top, right, bottom);
            numpadLayout.setLayoutParams(layoutParams);
        } else if (getScreenHeight() >= 700) {
            int left = getPixelValue(this, getResources().getDimension(R.dimen._8sdp));
            int top = getPixelValue(this, getResources().getDimension(R.dimen._10sdp));
            int right = getPixelValue(this, getResources().getDimension(R.dimen._8sdp));
            int bottom = getPixelValue(this, getResources().getDimension(R.dimen._7sdp));
        ...
        mStartCall.setVisibility(View.VISIBLE);
    ...
    private void updateLayout() {
        ...
        if (!atLeastOneCall) {
            if (core.getVideoActivationPolicy().getAutomaticallyInitiate()) {
                ...
                mStartCall.setImageResource(R.drawable.ic_call_white_24dp);
            }
        }
