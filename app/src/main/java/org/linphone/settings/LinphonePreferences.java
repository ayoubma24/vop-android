...
public class LinphonePreferences {
    ...
    public void saveAccountNumber(String num) {
        SharedPreferences.Editor editor =
                mContext.getSharedPreferences("pref", MODE_PRIVATE).edit();
        editor.putString("acc", num);
    ...
    public String getAccountNum() {
        ...
        String name = prefs.getString("acc", "No  defined");
        return name;
    }
}
